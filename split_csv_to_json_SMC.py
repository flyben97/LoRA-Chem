...
def create_instruction(description, yield_value):
    return {
        ...
        "input": f"{description}",
        "output": f"OK, this is a Suzuki-Miyaura Cross-Coupling reaction. Based on the chemical reaction information you provided, the yield of this reaction is: {str(yield_value)}%.",
        "history": []
    }
