...
def generate_reaction_description(row):
    ...
    template = (
        # "The first reactant is {S1_name} with SMILES {S1_smiles}, "
        # "the second reactant is {S2_name} with SMILES {S2_smiles}, "
        # "the product formed is {Product_name} with SMILES {Product_smiles}, "
        "The first reactant is {S1_name}, "
        "the second reactant is {S2_name}, "
        "the product formed is {Product_name}, "       
        "This is a SHC-oAK reaction."
    )
    ...
    description = template.format(
        ...
        # S1_smiles=row['S1_smiles'],
        # S2_smiles=row['S2_smiles'],
